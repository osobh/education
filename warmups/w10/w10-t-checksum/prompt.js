...
var alphaChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    if (Array.prototype.reduce) {
        return importantData.split("").reduce(function(a,b){a=((a<<5)-a)+b.charCodeAt(0);return a&a},0);   
    } else {
...
// function computeChecksum(importantData) {
// 	var hash = 0, i = 0, len = importantData.length, chr;
//             while ( i < len ) {
//                     hash  = ((hash << 5) - hash + importantData.charCodeAt(i++)) << 0;
//             }
//             return hash;
}
