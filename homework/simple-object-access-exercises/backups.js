...
//updating it manually work and it changes the value
//store2['inventory prices']['Mint Wafers'] = '1.990';
//console.log(store2['inventory prices']);
...
store3[1]['inventory sold']['Berry Bites'].cost = 3.90;
console.log(berryBitesData);
